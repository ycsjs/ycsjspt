...
define('APP_UPLOAD_RELATIVE_PATH', UPLOAD_RELATIVE_PATH . '/' . APP_TYPE . '/' . APP_NAME . '/'); //项目上传文件目录，该文件在生产环境不给可执行权限
//路径相关[E]

//域名相关[S]
define('APP_HTTP_URL', ITRAVEL_URL); //旅游项目URL地址
//域名相关[E]
